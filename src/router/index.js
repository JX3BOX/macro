...
const routes = [
    ...
    // 应用
    { name: "macroeditor", path: "/macroeditor", component: () => import("../views/MacroEditor.vue") },
    { name: "talent", path: "/talent", component: () => import("../views/Talent.vue") },
    { name: "talent2", path: "/talent2", component: () => import("../views/Talent2.vue") },
    { name: "meridians", path: "/meridians", component: () => import("../views/Meridians.vue") },
];
