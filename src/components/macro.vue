<template>
	<div class="u-macro-inner">
		...
		<div class="u-panel u-macro-panel">
			...
			<a class="u-macro-panel-test el-button el-button--mini is-plain" v-if="isSuperAdmin || isAuthor" :href="'https://pull.j3cx.com/api/macro/query?name=' + testname + '&_no_cache'" target="_blank" title="默认存在1分钟缓存，如需要即时生效请点击此按钮"> <i class="el-icon-video-play"></i> 云端同步刷新 </a>
		</div>
		<div class="u-count">
			字数：
			<b>{{ count }}</b>
