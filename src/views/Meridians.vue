...
<script>
import Yutang from "@/components/meridians/yutang";
import Qugu from "@/components/meridians/qugu";
import Detail from "@/components/meridians/detail";
import Xuanshu from "@/components/meridians/xuanshu";
import Mingmen from "@/components/meridians/mingmen";
import Yaoshu from "@/components/meridians/yaoshu";
import Tianchong from "@/components/meridians/tianchong";
import Weidao from "@/components/meridians/weidao";
import Dahe from "@/components/meridians/dahe";
import Henggu from "@/components/meridians/henggu";
import Qixue from "@/components/meridians/qixue";
import AppLayout from "@/layout/AppLayout";

import constDefine from "@/assets/data/v1";
